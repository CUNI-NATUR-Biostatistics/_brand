...
generate_skripta_html_theme <- function(
  ...
  lines <-
    c(
      ...
      "// ---------------------------------------------------------------------------",
      "$callout-color-note:      $amethyst;",
      "$callout-color-tip:       $grey_olive;",
      "$callout-color-warning:   $orange;",
      "$callout-color-important: $indigo_velvet;",
      "$callout-color-caution:   #C94C4C;",
      "",
      "",
      "/*-- scss:rules --*/",
      "",
      "// Approved course logo on the reading-material title block.",
      ...
      "  background: url('../theme/course-logo-horizontal.svg') left center / contain no-repeat;",
      "}",
      "",
      "// ---------------------------------------------------------------------------",
      "// Semantic question callout (created by theme/semantic-boxes.lua)",
      "// ---------------------------------------------------------------------------",
      "div.callout-question.callout {",
      "  border-left-color: shift-color($orange, $callout-border-scale);",
      "}",
      "",
      "div.callout-question.callout-style-default > .callout-header {",
      "  background-color: shift-color($orange, -90%);",
      "}",
      "",
      "// ---------------------------------------------------------------------------",
      "// Long optional material: retain the HTML collapse affordance.",
      "div.callout-extra.callout {",
      "  border-left-color: shift-color($amethyst, $callout-border-scale);",
      "}",
      "",
      "// Code blocks",
      "// ---------------------------------------------------------------------------",
      ...
      "  border-spacing: 0;",
      paste0(
        "  border: 1px solid rgba($tableBorderColor, ",
