...
generate_r_theme <- function(
  ...
  lines <-
    c(
      ...
      paste0('    legend.background = ggplot2::element_rect(fill = "', bg_color, '", colour = NA),'),
      paste0('    legend.key       = ggplot2::element_rect(fill = "', bg_color, '", colour = NA),'),
      paste0('    strip.text       = ggplot2::element_text(face = "', ggplot_sz$stripTextFace, '"),'),
      '    axis.title.x     = ggplot2::element_text(margin = ggplot2::margin(t = 6)),',
      '    axis.title.y     = ggplot2::element_text(margin = ggplot2::margin(r = 8)),',
      '    panel.border     = ggplot2::element_blank(),',
      paste0('    axis.line        = ggplot2::element_line(colour = "', text_color, '", linewidth = 0.4),'),
      paste0('    panel.background = ggplot2::element_rect(fill = "', primary[["white"]], '", colour = NA),'),
